...
class ScribdBypass:
    ...
    def generate_scribd_metadata(self, file_type: str = "document") -> Dict[str, Any]:
        ...
        """
        # Tạo timestamp ngẫu nhiên trong 2 năm gần đây
        current_time = int(time.time())
        random_time = current_time - random.randint(0, 63072000)  # 2 năm
        
        # Tạo ID ngẫu nhiên
        random_id = ''.join(random.choices(string.ascii_letters + string.digits, k=16))
        
        # Metadata cơ bản cho Scribd
        base_metadata = {
